...
if (isset($_SESSION['adminId'])){
    ...
    $selectBack = "SELECT * FROM `background` WHERE id='4'";
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    <form action="../validate/change_background.php" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="snId" value="4" class="btn btn-primary mr-2">Submit</button>
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 ml-auto mr-auto mt-3">
                    <nav aria-label="">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="background-3.php" tabindex="-1">Previous</a>
                            </li>
                            <li class="page-item">
                            ...
                            <li class="page-item active">
                                <a class="page-link" href="background-4.php">4 <span class="sr-only">(current)</span></a>
                            </li>
