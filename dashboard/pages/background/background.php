...
if (isset($_SESSION['adminId'])){
    ...
    $selectBack = "SELECT * FROM `background` WHERE id='1'";
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="">
                        <img class="d-block w-100" src="../../../images/background/<?php echo $afterAssocBack['pic']; ?>" alt="First slide">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mt-3">
                    <form action="../validate/change_background.php" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="snId" value="1" class="btn btn-primary mr-2">Submit</button>
                        <a href="background-2.php" class="btn btn-light">Skip</a>
                    </form>
                </div>
            </div>
            <div class="row">
                    ...
                    <nav aria-label="">
                        <ul class="pagination">
                            ...
                            <li class="page-item active">
                                <a class="page-link" href="background.php">1 <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="page-item">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="background-2.php">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
